...
/**
 * This class contains constants for configuration keys and default values used
 * in hdfs.
 */
@InterfaceAudience.Private
public class DFSConfigKeys extends CommonConfigurationKeys {
    //-[linesyao]
    public static final String DFS_DN_EC_REPAIRBOOST_KEY = "dfs.datanode.ec.repairboost";
    public static final Boolean DFS_DN_EC_REPAIRBOOST_DEFAULT = false;
    public static final String DFS_DN_EN_REPARIBOOST_COORDINATOR = "192.168.0.201";
    ///
    ...
    public static final long DFS_DATANODE_BALANCE_BANDWIDTHPERSEC_DEFAULT = 10 * 1024 * 1024;
    ...
    /*
     * Phrased as below to avoid javac inlining as a constant, to match the behavior
     * when this was AuthFilter.class.getName(). Note that if you change the import
     * for AuthFilter, you need to update the literal here as well as
     * TestDFSConfigKeys.
     */
    public static final String DFS_WEBHDFS_AUTHENTICATION_FILTER_DEFAULT = "org.apache.hadoop.hdfs.web.AuthFilter";
    @Deprecated
    ...
    public static final String DFS_DATANODE_OOB_TIMEOUT_DEFAULT = "1500,0,0,0"; // OOB_TYPE1, OOB_TYPE2, OOB_TYPE3,
                                                                                // OOB_TYPE4
    ...
    // This value uses the times of heartbeat interval to define the minimum value
    // for stale interval.
    public static final String DFS_NAMENODE_STALE_DATANODE_MINIMUM_INTERVAL_KEY = "dfs.namenode.stale.datanode.minimum.interval";
    public static final int DFS_NAMENODE_STALE_DATANODE_MINIMUM_INTERVAL_DEFAULT = 3; // i.e. min_interval is 3 *
    ...
    /**
     * The maximum number of getBlocks RPCs data movement utilities can make to a
     * NameNode per second. Values <= 0 disable throttling. This affects anything
     * that uses a NameNodeConnector, i.e., the Balancer, Mover, and
    ...
    public static final String DFS_IMAGE_EXPANDED_STRING_TABLES_KEY = "dfs.image.string-tables.expanded";
    ...
    @Deprecated
    public static final long DFS_CLIENT_WRITE_EXCLUDE_NODES_CACHE_EXPIRY_INTERVAL_DEFAULT = HdfsClientConfigKeys.Write.EXCLUDE_NODES_CACHE_EXPIRY_INTERVAL_DEFAULT; // 10
                                                                                                                                                                    // minutes,
                                                                                                                                                                    // in
                                                                                                                                                                    // ms
    @Deprecated
    ...
    // the initial delay (unit is ms) for locateFollowingBlock, the delay time will
    // increase exponentially(double) for each retry.
    @Deprecated
