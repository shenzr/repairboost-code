...
class ErasureCodingWork extends BlockReconstructionWork {
  ...
  void chooseTargets(BlockPlacementPolicy blockplacement,
    ...
    //-[linesyao]
    BlockManager.LOG.info("LinesYao choose target in ErasureCodingWork.java for blk , " + (new ExtendedBlock(blockPoolId, (BlockInfoStriped) getBlock())).getBlockName());
    ///
  ...
  @Override
  void addTaskToDatanode(NumberReplicas numberReplicas) { // [linesyao] add erasure-coding repair task to dn
